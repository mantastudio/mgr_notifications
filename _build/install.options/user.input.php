...
/**
 * Script to interact with user during mgr_notifications package install
 *
...
/**
 * Description: Script to interact with user during mgr_notifications package install
 * @package mgr_notifications
 * @subpackage build
 */
