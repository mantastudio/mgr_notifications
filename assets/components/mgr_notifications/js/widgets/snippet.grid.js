...
mgr_notifications.grid.Snippets = function (config) {
    config = config || {};
    ...
    Ext.applyIf(config, {
        ...
        , tbar: [{
            ...
            ,{
                xtype: 'button'
                , id: 'mgr_notifications-snippets-reload'
                , text: 'reload'
                , listeners: {
    ...
    mgr_notifications.grid.Snippets.superclass.constructor.call(this, config)
};
Ext.extend(mgr_notifications.grid.Snippets, MODx.grid.Grid, {
    ...
    , changeCategory: function (btn, e) {
        ...
        if (!this.changeCategoryWindow) {
            this.changeCategoryWindow = MODx.load({
                  xtype: 'mgr_notifications-snippet-window-change-category'
                  , record: r
                  , listeners: {
                    'success': {fn: function (r) {
                        // this.refresh();
                        var sels = this.getSelectionModel().getSelections();
                        var cat = Ext.getCmp('mgr_notifications-snippet-category-combo').lastSelectionText;
                        var s = this.getStore();
...
Ext.reg('mgr_notifications-grid-snippet', mgr_notifications.grid.Snippets);
...
mgr_notifications.window.ChangeCategory = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        ,fields: [{
            ...
            ,id: 'mgr_notifications-snippet-category-combo'
...
Ext.reg('mgr_notifications-snippet-window-change-category', mgr_notifications.window.ChangeCategory);
