...
mgrnotifications.grid.Chunks = function (config) {
    config = config || {};
    ...
    Ext.applyIf(config, {
        ...
        , tbar: [{
            ...
            ,{
                xtype: 'button'
                , id: 'mgrnotifications-chunks-reload'
                , text: 'reload'
                , listeners: {
    ...
    mgrnotifications.grid.Chunks.superclass.constructor.call(this, config)
};
Ext.extend(mgrnotifications.grid.Chunks, MODx.grid.Grid, {
    ...
    , changeCategory: function (btn, e) {
        ...
        if (!this.changeCategoryWindow) {
            this.changeCategoryWindow = MODx.load({
                  xtype: 'mgrnotifications-chunk-window-change-category'
                  , record: r
                  , listeners: {
                    'success': {fn: function (r) {
                        // this.refresh();
                        var sels = this.getSelectionModel().getSelections();
                        var cat = Ext.getCmp('mgrnotifications-chunk-category-combo').lastSelectionText;
                        var s = this.getStore();
...
Ext.reg('mgrnotifications-grid-chunk', mgrnotifications.grid.Chunks);
...
mgrnotifications.window.ChangeCategory = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        ,fields: [{
            ...
            ,id: 'mgrnotifications-chunk-category-combo'
...
Ext.reg('mgrnotifications-chunk-window-change-category', mgrnotifications.window.ChangeCategory);
